...
__Although neither this nor <<Kontaktopplysning-kontaktside>> is mandatory, one of them MUST be used when the class is used.__
...
__Although neither this nor <<Kontaktopplysning-harEPost>> is mandatory, one of them MUST be used when the class is used.__
|===
