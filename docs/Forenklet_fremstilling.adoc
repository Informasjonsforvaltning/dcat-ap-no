...
.For deg som er teknisk interessert: klikk her for å se eksemplene ovenfor representert i RDF Turtle, i henhold til kravene spesifisert videre i standarden.
[%collapsible]
====
