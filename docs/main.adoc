...
*Publisert*: [yellow-background]#2020-09-29# +
*Lenke til gjeldende versjon*: https://data.norge.no/specification/dcat-ap-no

WARNING: *Det pågår løpende justeringer*: +
Inntil standarden blir endelig pbulisert som gjeldende versjon (se over), blir utkastet (denne publiseringen) løpende justert for bl.a. å hensynta kommentarer og innspill fra høringsrunden.
