...
* *Datasett med høy verdi (_High Value Datasets_, HVD)*: Det er en egen standard, https://data.norge.no/specification/hvd-dcat-ap-no/[HVD-DCAT-AP-NO  &#x29C9;, window="_blank", role="ext-link"], som gjelder for beskrivelse av datasett med høy verdi. 
