...
<<img-KlassenKatalog>> viser klassen Katalog og dens egenskaper, samt klassene den refererer til.  
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | #Norsk utvidelse#: Kravnivået er endret fra anbefalt til valgfri. #NB! Sjekk mot profile-guidelines om det er lov å senke kravnivået!#
