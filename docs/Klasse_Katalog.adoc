...
| Eksempel / _Example_ | «En eksempelkatalog, kun for demo formål.» (bokmål) / __"An example catalog, for demo purposes only." (English)__
|===

Eksempel i RDF Turtle:
-----
<aCatalog> a dcat:Catalog ; 
   dct:description "En eksempelkatalog, kun for demo formål."@nb , "An example catalog, for demo purposes only."@en ; 
   .
-----
