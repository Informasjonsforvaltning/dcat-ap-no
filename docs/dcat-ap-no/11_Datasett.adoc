...
|Beskrivelse| Referanse til objekt som beskriver arvelinjen/proveniens til datasettet (dvs. endring av eierskap etc. etter at datasettet ble skapt, som kan ha betydning for datasettets autentisitet, integritet og fortolkning)
|Multiplisitet| 0..1
|Status| Valgfri
|===
