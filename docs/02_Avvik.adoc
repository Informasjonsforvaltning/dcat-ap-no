...
Denne versjonen av DCAT-AP-NO avviker BRegDCAT-AP (v.2.00) på følgende måter: #(ikke oppdatert)#

[cols="15,15,35,35"]
|===
|*Klasse-/egenskapsnavn*|*URI for klassen/egenskapen*|*Avvik*|*Forklaring*
|Datasett: i serie|dcat:inSeries|Ikke eksplisitt tatt med i BRegDCAT-AP|Er i DCAT-AP-NO v.2.1 | For å dekke behov for datasettserie
|Datasett: forrige |dcat:prev|Ikke eksplisitt tatt med i BRegDCAT-AP|Er i DCAT-AP-NO v.2.1 | For å dekke behov for datasettserie
|Datasett serie |dcat:DatasetSeries|Ikke eksplisitt tatt med i BRegDCAT-AP|Er i DCAT-AP-NO v.2.1 | For å dekke behov for datasettserie
|Datasett serie: første |dcat:first|Ikke eksplisitt tatt med i BRegDCAT-AP|Er i DCAT-AP-NO v.2.1 | For å dekke behov for datasettserie
|Datasett serie: siste |dcat:last|Ikke eksplisitt tatt med i BRegDCAT-AP|Er i DCAT-AP-NO v.2.1
