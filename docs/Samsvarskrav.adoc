...
I konteksten av denne standarden, betyr det «å prosessere» at den mottakende applikasjonen aksepterer innkommende data og transparent videreformidler dataene til aktuelle applikasjoner og tjenester. 
