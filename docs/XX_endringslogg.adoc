...
| Datasett – romlig oppløsning | dcat:spatialResolutionInMeters | Multiplisiteten endret fra 0..n til 0..1 | Følger DCAT-AP.
| Datasett – refererer til | dct:references | utgått | Følger DCAT-AP (invers egenskap).
| Datasett – tidsoppløsning | dcat:temporalResolution | Multiplisiteten endret fra 0..n til 0..1 | Følger DCAT-AP.
...
| Datasett – type | dct:type | Multiplisiteten endret fra 0..1 til 0..n | Følger DCAT-AP.
...
| Datatjeneste – landingsside | dcat:landingPage | Multiplisitet endret fra 0..1 til 0..n | Følger DCAT-AP.
