...
Fra 2.1 til 2.2:
* Lagt til ny egenskap Datasett: i serie (`dcat:inSeries`), klassen Datsett serie (`dcat:DatasetSeries`) og egenskapene første (`dcat:first`), siste (`dcat:last`) og forrige (`dcat:prev`) som er ny i DCAT 3.  
