...
*** <<Datasett-beskrivelse>>: Verdiområdet endret fra rdfs:Literal til rdf:langString som er en subklasse av rdfs:Litereal. 
*** <<Datasett-tittel>>: Verdiområdet endret fra rdfs:Literal til rdf:langString som er en subklasse av rdfs:Litereal. 
*** <<Datasett-emneord>>: Verdiområdet endret fra rdfs:Literal til rdf:langString som er en subklasse av rdfs:Litereal. 
*** <<Datasett-versjonsmerknad>>: Verdiområdet endret fra rdfs:Literal til rdf:langString som er en subklasse av rdfs:Litereal. 
