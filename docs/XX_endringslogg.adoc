...
** *Endrede kravnivå og/eller multiplisitet*: 
*** <<Distribusjon-beskrivelse>>: Føyet til følgende krav: Det SKAL være maks. 1 verdi per språk.
...
*** <<Distribusjon-tittel>>: Føyet til følgende krav: Det SKAL være maks. 1 verdi per språk.
