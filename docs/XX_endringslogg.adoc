...
Fra 2.1 til 2.2:
* Lagt til nye egenskaper for Datasett: i serie (`dcat:inSeries`) og egenskapen forrige (`dcat:prev`) som er ny i DCAT 3.  
* Lagt til ny klasse Datsett serie (`dcat:DatasetSeries`) og egenskapene første (`dcat:first`) og siste (`dcat:last`) som er nye i DCAT 3.  
