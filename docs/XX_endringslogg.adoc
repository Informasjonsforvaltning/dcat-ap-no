...
Tabellen under viser hva som er nye, utgåtte, endrede klasser og egenskaper. 
...
| Datasett – versjonsmerknad | adms:versionNotes | Norsk egenskapsnavn endret (fra versjonsnote) | Bedre norsk oversettelse.
