...
Hele klassen: Ikke eksplisitt spesifisert DCAT-AP/DCAT. `odrs:RightsStatement` er en subklasse av `dct:RightsStatement` brukt i DCAT-AP. 

__The whole class: Not explicitly specified in DCAT-AP/DCAT. `odrs:RightsStatement` is a subclass of `dct:RightsStatement` used in DCAT-AP._
