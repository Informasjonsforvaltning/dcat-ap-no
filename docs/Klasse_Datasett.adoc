...
=== Datasett: geografisk oppløsning (dcat:spatialResolutionInMeters) [[datasett-geografisk-oppløsning]]
...
=== Datasett: har kvantifiserbart måleresultat (dqv:hasQualityMeasurement) [[datasett-har-kvantifiserbart-måleresultat]]
