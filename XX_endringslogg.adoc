...
*** <<Datatjeneste-versjonsmerknad>>: Tilføyet følgende krav: Det SKAL være maks. 1 verdi per språk.
...
** *Endrede kravnivå og/eller multiplisitet*: 
*** <<Standard--tittel>>: Tilføyet følgende krav: Det SKAL være maks. 1 verdi per språk.
** *Endrede verdiområder*: 
*** <<Standard--tittel>>: Verdiområdet endret fra rdfs:Literal til rdf:langString som er en subklasse av rdfs:Literal. 
