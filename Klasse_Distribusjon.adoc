...
| Eksempel | En nedlastbar fil i csv eller en menneskelesbar html-visning av et datasett.  
|===
...
| Merknad / _Note_ | Se også under <<Om-datasett-datatjeneste-distribusjon>> for hvordan denne egenskapen er ment å brukes.

__See also under <<Om-datasett-datatjeneste-distribusjon>> (in Norwegian only) for how this property is meant to be used.__
|===
...
| Multiplisitet / _Multiplicity_ | 0..n
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | For referanse til Lovdata bør ELI-URI brukes, se https://lovdata.no/eli/[beskrivelsen hos Lovdata &#x29C9;, window="_blank", role="ext-link"].
