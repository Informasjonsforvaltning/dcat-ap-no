...
|Multiplisitet| 0..1
|Status| Anbefalt
|Kommentar|Norsk utvidelse - endret fra valgfri til anbefalt, fordi status på tjenesten er viktig å vite når man skal vurdere om en tjeneste skal/kan brukes.
|===
