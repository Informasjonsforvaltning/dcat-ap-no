...
| Multiplisitet / _Multiplicity_ | 0..1
| Kravnivå / _Requirement level_ | Valgfri / _Optional_
| Merknad / _Note_ | Norsk utvidelse: Verdien BØR være en medietype fra det offisielle registeret av https://www.iana.org/assignments/media-types/media-types.xhtml[medietyper forvaltet av IANA &#x29C9;, window="_blank", role="ext-link"]. 
...
__Norwegian extension: It SHOULD be expressed using a media type as defined in the official register of https://www.iana.org/assignments/media-types/media-types.xhtml[media types managed by IANA &#x29C9;, window="_blank", role="ext-link"].__
