...
I tillegg til å stille krav til hva skal/bør/kan tas med i beskrivelser av datasett, datatjenester og datakataloger, spesifiserer denne delen av standarden også hvordan beskrivelsene skal representeres til RDF (https://www.w3.org/RDF/[Resource Description Framework &#x29C9;, window="_blank", role="ext-link"]). Det forutsettes derfor kjennskap til RDF (å kunne lese RDF) og informasjonsmodellering (å kunne forstå en informasjonsmodell). 
