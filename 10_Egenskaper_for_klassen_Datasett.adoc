...
URI:: adms:contactPoint
Range:: v:Vcard
Beskrivelse:: Inneholder kontaktinformasjon som kan brukes for å melde om feil i datasettet eller sende kommentarer
Kardinalitet:: 1..n
Status:: Anbefalt
...
Range:: dct:Frequency
Beskrivelse:: Referer til oppdateringsfrekvensen for datasettet
Kardinalitet:: 0..1
Status:: Valgfri
