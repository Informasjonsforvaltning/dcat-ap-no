...
WARNING: Dette er utkast til neste versjon (v2.3) av DCAT-AP-NO. Dersom du finner feil eller mangler i dokumentet, ber vi om at dette meldes inn på https://github.com/Informasjonsforvaltning/dcat-ap-no/issues[Github Issues]. Dersom du ikke allerede har bruker på Github kan du opprette bruker gratis.


*Status*: #Redaktørens utkast# +
*Versjon*: Utkast til versjon 2.3 (se <<Endringslogg, endringsloggen>>) +
*Oppdatert*: 2022-11-07  +
