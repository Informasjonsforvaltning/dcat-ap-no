...
__Norwegian extension: Not explicitly specified in DCAT-AP/DCAT.__
| Merknad 2 / _Note 2_ | Selv om hverken denne eller <<Kontaktopplysning-kontaktside>> er obligatorisk, SKAL minst én av dem brukes når klassen brukes.  

__Although neither this nor <<Kontaktopplysning-kontaktside>> is mandatory, at least one of them MUST be used when the class is used.__
...
__Norwegian extension: Not explicitly specified in DCAT-AP/DCAT.__
| Merknad 2 / _Note 2_ | Selv om hverken denne eller <<Kontaktopplysning-harEPost>> er obligatorisk, SKAL minst én av dem brukes når klassen brukes.  

__Although neither this nor <<Kontaktopplysning-harEPost>> is mandatory, at least one of them MUST be used when the class is used.__
|===

Eksempel i RDF Turtle:
-----
<aContactPoint> a vcard:Organization ; 
   vcard:hasURL <https://https://data.norge.no/nb/contact> ; 
   .
-----
